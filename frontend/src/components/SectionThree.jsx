    ...
    return (
        ...
        >
            ...
            <div className="max-w-5xl mx-auto text-left">
                <span
                    className={`block text-2xl font-krona font-bold mb-2 transition-all duration-700 ${sobreNosVisible ? 'animate-slideInLeft' : 'opacity-0'
                        }`}
                >
                    03.
                </span>
                <h2
                    className={`text-2xl md:text-4xl group-has-[.featured-media]:md:text-3xl font-krona font-semibold mb-4 transition-all duration-700 ${sobreNosVisible ? 'animate-slideInLeft' : 'opacity-0'
                        }`}
                >
                    SOBRE NÓS
                </h2>
                ...
                <p
                    className={`text-lg font-montserrat mb-12 max-w-3xl transition-all duration-700 ${sobreNosVisible ? 'animate-slideInLeft' : 'opacity-0'
                        }`}
                >
        ...
        */}
                <div className="flex flex-wrap justify-center md:flex-row md:justify-around gap-x-12 gap-y-6 max-w-sm mx-auto md:max-w-none">
                    ...
                    <div
                        className={`flex flex-col items-center text-center transition-all duration-700 ${sobreNosVisible ? 'animate-slideInLeft' : 'opacity-0'
                            } w-24 md:w-48`}
                    >
                        <img
                    ...
                    <div
                        className={`flex flex-col items-center text-center transition-all duration-700 delay-200 ${sobreNosVisible ? 'animate-slideInLeft' : 'opacity-0'
                            } w-24 md:w-48`}
                    >
                        <img
                            src="/assets/vini.jpg"
                        ...
                        <div className="flex gap-4 mt-2">
                            <a href="https://github.com/deceptionfalls" target="_blank" rel="noopener noreferrer">
                                <img src="/assets/gith.png" alt="GitHub" className="w-6 h-6 md:w-12 md:h-12" />
                            </a>
                            <a href="https://www.linkedin.com/in/vinicius-de-souza-gonçalves-vitorino-8a4554327" target="_blank" rel="noopener noreferrer">
                                <img src="/assets/linkedin.png" alt="LinkedIn" className="w-6 h-6 md:w-12 md:h-12" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div
                        className={`flex flex-col items-center text-center transition-all duration-700 delay-400 w-full md:w-48 ${sobreNosVisible ? 'animate-slideInLeft' : 'opacity-0'
                            } mt-6 md:mt-0`}
                    >
                        <img
                            src="/assets/igor.jpg"
