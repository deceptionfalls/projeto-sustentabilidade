		...
		<section className="bg-[#25412B] text-[var(--accent-green)] px-6 lg:px-20 py-20">
			<div className="max-w-5xl mx-auto">
				...
				<div className="mt-12 flex flex-col sm:flex-row justify-center items-center sm:items-stretch gap-8">
					...
					{/* Card 1: Reduza (Mantém) */}
					<div className="flex flex-col items-center text-center w-full max-w-sm sm:w-72 transition-all duration-300 hover:scale-[1.05]">
						<div className="bg-[var(--accent-green)] hover:bg-[#6B8E23] transition-all duration-300 rounded-2xl overflow-hidden shadow-lg hover:-translate-y-1 w-full h-72 flex items-center justify-center">
							<img src="assets/reduce.png" alt="Reduza" className="w-full h-full object-contain p-2" />
						</div>
						<h3 className="text-2xl font-krona mt-4 mb-2">Reduza</h3>
						<p className="text-base font-montserrat">Consuma de forma consciente e evite excessos.</p>
					</div>

					{/* Card 2: Recicle*/}
					<div className="flex flex-col items-center text-center w-full max-w-sm sm:w-72 transition-all duration-300 hover:scale-[1.05]">
						<div className="bg-[var(--accent-green)] hover:bg-[#6B8E23] transition-all duration-300 rounded-2xl overflow-hidden shadow-lg hover:-translate-y-1 w-full h-72 flex items-center justify-center">
							<img src="assets/recycle.png" alt="Recicle" className="w-full h-full object-contain p-2" />
						</div>
						<h3 className="text-2xl font-krona mt-4 mb-2">Recicle</h3>
						<p className="text-base font-montserrat">Dê destino correto aos seus eletrônicos antigos.</p>
					</div>

					{/* Card 3: Reutilize*/}
					<div className="flex flex-col items-center text-center w-full max-w-sm sm:w-72 transition-all duration-300 hover:scale-[1.05]">
						<div className="bg-[var(--accent-green)] hover:bg-[#6B8E23] transition-all duration-300 rounded-2xl overflow-hidden shadow-lg hover:-translate-y-1 w-full h-72 flex items-center justify-center">
							<img src="assets/reuse.png" alt="Reutilize" className="w-full h-full object-contain p-2" />
						</div>
						<h3 className="text-2xl font-krona mt-4 mb-2">Reutilize</h3>
						<p className="text-base font-montserrat">Prolongue a vida útil dos seus dispositivos.</p>
					</div>
				</div>
